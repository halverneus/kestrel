...
```bash
sudo bootc switch ghcr.io/halverneus/kestrel:latest
```

This image was created using the [Universal Blue Image Template](https://github.com/ublue-os/image-template).
